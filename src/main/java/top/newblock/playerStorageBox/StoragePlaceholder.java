...
public class StoragePlaceholder extends PlaceholderExpansion {
    ...
    public StoragePlaceholder(PlayerStorageBox plugin, StorageManager manager) { this.plugin = plugin; this.manager = manager; }
    ...
    @Override public String onPlaceholderRequest(Player player, @NotNull String params) {
        ...
        if (params.equalsIgnoreCase("total_value")) return String.valueOf(manager.getTotalValue(player.getUniqueId()));
        return null;
    }
}